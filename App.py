"""
Dashboard Financeiro Caec — Versão FINAL #9: Conserto de Sintaxe e Refinamento Final de UI.
Garante que todos os parênteses estejam fechados e mantém todas as melhorias de design.
"""
...
def get_dynamic_css() -> str:
    """
    Gera o CSS dinâmico. Mantém as correções de H1, Cards, e Responsividade Mobile.
    """
    ...
    /* CORREÇÃO APLICADA: Título H1 com cor dinâmica (preto/branco) */
    h1 {{ 
        margin-top: 0rem; 
        margin-bottom: 1rem; 
    ...
    /* Remove estilos de card para elementos aninhados */
    ...
    /* Fundo dos Gráficos (Plotly) deve ser transparente para herdar o fundo do card */
    ...
    @media (max-width: 600px) {{
        ...
        /* Garante que colunas se quebrem para layout vertical em mobile */
        .st-emotion-cache-1r6ftg6 {{ 
            display: block !important;
        }}
        .st-emotion-cache-1d3x7py {{ 
            width: 100% !important;
...
def main():
    ...
    # LINHA CORRIGIDA: A chamada da função está completa.
    ...
    if page == "Resumo Financeiro":
        ...
        with tab_normais:
            ...
            # CARD 2.1 e 2.2: Barras de Porcentagem (Substitui Treemap)
            with st.container():
